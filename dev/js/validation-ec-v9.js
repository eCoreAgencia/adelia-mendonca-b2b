...
$(document).ready(function(){
	if(document.location.href.indexOf('?sc=2') > -1 ) {
		$('.owl-item a, .menu-departamento a, .bread-crumb li a, a.product-image, .header-qd-v1-user-links a, .header-qd-v1-logo a, .prateleira .shelf-qd-v1-image-link, h3.shelf-qd-v1-product-name a, .footer-qd-v1-links a').each(function(){
