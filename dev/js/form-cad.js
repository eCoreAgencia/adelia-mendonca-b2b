...
function sendCadastrar() {
	...
	if (validadeForm()) {
			...
			if ($('#file')[0].files[0]) {
				...
				$.ajax({
						type: 'POST',
						url: 'https://midleware.cognitionsystem.com.br/resales',
						crossDomain: true,
						data: data,
						dataType: 'json',
...
function saveData(data) {
	//Variables
	var url = "https://midleware.cognitionsystem.com.br/resales";
	var xhttp = null;
...
function uploadFile(data) {
	//Variables
	var url = "https://midleware.cognitionsystem.com.br/sendfile";
