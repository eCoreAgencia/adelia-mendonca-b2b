...
if(document.location.href.indexOf('/?sc=2') > -1 ) {
	$('.menu-departamento a, .header-qd-v1-user-links a, #logo a .prateleira .shelf-qd-v1-image-link, h3.shelf-qd-v1-product-name a, .footer-qd-v1-links a').each(function(){
